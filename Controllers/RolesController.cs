...
namespace Reserva_de_equipos.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(DbReservaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RolId,Nombre,Descripción")] Rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RolId,Nombre,Descripción")] Rol rol)
        {
            if (id != rol.RolId)
            {
                return NotFound();
